                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
										...
										<p>
											Lütfen giriş yapın veya yeni hesap oluşturun.
										</p>
                                    </div>
                                    ...
                                    <form action="" method="post" class="user">
                                        ...
                                        <button type="submit" name="giris" value="1" class="btn btn-primary btn-user btn-block">
                                            Giriş Yap
                                        </button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a href="<?=site_url('kayit')?>" class="small">
											Hesap Oluştur!
										</a>
                                    </div>
                                </div>
